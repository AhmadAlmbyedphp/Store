                    ...
                    <div class="product-sidebar">
                        ...
                        <div class="single-widget search">
                            ...
                            <form action="{{ URL::current() }}" method="get" class="d-flex justify-content-between mb-4">
                                ...
                                <button class="btn btn-dark mx-2 "><i class="lni lni-search-alt"></i></button>
                            </form>
                        </div>
                        <!-- End Single Widget -->
                        <!-- Start Single Widget -->
                            ...
                            <ul class="list">
                                @foreach ( $categories as $category)
                                    <li>
                                        ...
                                        <a href="">{{$category->name}}</a><span>(1138)</span>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
                                            ...
                                            <div class="col-lg-4 col-md-6 col-12">
                                                ...
                                                <div class="single-product">
                                                    ...
                                                    <div class="product-info">
                                                        ...
                                                        <h4 class="title">
                                                            <a href="{{ route('products.shew',$product->slug) }}">{{$product->name}}</a>
                                                        </h4>
                                                        <ul class="review">
                                    ...
                                    <div class="col-12">
                                        ...
                                        {{-- <div class="pagination left">
                                            <ul class="pagination-list">
                                                <li>{{ $products->withQueryString()->links()}}</li>
                                            </ul>
                                        </div>
                                        <!--/ End Pagination --> --}}
                                    </div>
                            ...
                            <div class="tab-pane show active fade" id="nav-list" role="tabpanel"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="pagination left">
                                            <ul class="pagination-list">
                                                <li>{{$products->withQueryString()}}</li>
                                            </ul>
                                        </div>
                                        <!--/ End Pagination --> --}}
                                    </div>
